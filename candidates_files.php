...
if(isset($_SESSION['firstname']) && isset($_POST['submit']))
{
  ...
  $query=mysqli_query($conn,"insert into files(added_on,file_type,visibility,validity,files,kb,firstname) values('$date','$file_type','$visibility','$validity','$compfile','$filesize','$firstname')");
...
<div class="delete">
<span style="color:red"><a href='./include/delete.php?id=<?php echo $row["file_id"] ?>' onclick='checkdelete()' style="color:red;text-decoration:none">Delete</a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
