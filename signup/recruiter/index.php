...
<?php include('../navMenu.php')?>
 ...
 <form action="company_details.php" method="post">
                    <div class="row-signup input-section-row">
                        ...
                        <div class="input-signup-div">
                            <label for="input-first-name">Last name<span>*</span></label>
                            <input type="text" name="lastname" placeholder="Last name" id="input-first-name" required>
                        </div>
                        <div class="input-signup-div">
                            <label for="input-first-name">Email address<span>*</span></label>
                            <input type="email" name="email" placeholder="Email address" id="input-first-name" required>
                        </div>
                        <div class="input-signup-div">
                            <label for="input-first-name">Phone number<span>*</span></label>
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                            </select><input type="tel" maxlength='10' name="number" placeholder="Phone number" id="input-first-name" class="phn-number--input-signup" required></div>
                        </div>
                        <div class="input-signup-div">
