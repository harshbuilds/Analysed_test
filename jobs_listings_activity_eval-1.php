...
<div class="bread-crumbs_Mytools-recruiter">
  <a href="dashboard.php" class="active-breadcrumb-link">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<u>Dashboard</u> </a> >  <a href="candidate_list.php" class="active-breadcrumb-link"><u> My Database</u> </a> >  <a href="" class="active-breadcrumb-link"><u>Job Listings</u> </a>
...
<div class="row">
 ...
 <div class="options">
             ...
             <p class="p1"><a href="Job_listings_files.php?j_id=<?php echo  $job_id ?>" style="color: #979797">Files</a></p>
 ...
 <div class="col-lg-8 mb-4">
     ...
     <div class="row">
         <div class="col-8">
             <div class="leftFilter_myTasks">
                ...
                <form method="post">
                  <input type="text" name="FileName_myTasks" placeholder="Search by candidate name " class="inputSearchFileName_myTasks">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                  <button type="submit" name="btnsearch" class="searchButton_myTasks" style="align:center"><img src="img/search-icon-blue.png" width="17px" height="17px"></button>
               </form>
     ...
     <div class="row">
         <div class="col-11" id="display-btn">

           <form method="post">
             <p style="display:flex">
             <button type="submit" name="btnall" class="addFilesMyTasks1" id="myBtn" > All </button>&emsp;&emsp;
             <button type="submit" name="btnshortlisted" class="addFilesMyTasks2" id="myBtn" > Shortlisted </button>&emsp;&emsp;
     ...
     <div class="singleTasks_containerDiv">
         ...
         <div class="singletask_myTasks">
             ...
             <span>
                 ...
                 <p class="light_spanItem_singleTask_myTasks"><b><?php echo $recruiters_name; ?></b></p>
             </span>&emsp;
             <span>
                 <p class="light_spanItem_singleTask_myTasks">Added on  <span style="color:#333333"><?php echo $start_date; ?></span></p>
                 <p  class="light_spanItem_singleTask_myTasks"style="color:#3598DB;">&emsp;View resume</p>
             </span>
