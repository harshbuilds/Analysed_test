...
<body>
    ...
    <div class="bread-crumbs_Mytools-recruiter">
        <a href="js_dashboard.php"
            class="active-breadcrumb-link">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Dashboard</a> > <a
            href="candidate_list.php" class="active-breadcrumb-link">My Dashboard</a> > <a href="Job_listings.php"
            class="active-breadcrumb-link">Job Listing</a>
    </div>
                    ...
                    <div class="row" id="input-width" style="display: flex">
                        <div class="col-8">
                            <div class="input-field-job-list">
                                ...
                                <a href="/" class="active-breadcrumb-link">All Jobs &emsp; <span
                                        style="color:#979797">|&emsp; &emsp;</span></a>

                                <form method="post">
                                    <input type="text" name="searchForJobs" id="inputSearch" class="searchForJobs-list"
                                        placeholder="Search for Jobs by ID   " />&emsp;&emsp; &emsp;&emsp;&emsp;
                    ...
                    <div class="row">
                        <div class="col-4" id="btn-align">
                            <form method="post" id="btn-display">
                                <button type="submit" style="background: none;border: none;" name="btnhigh"><img
                                        src="img/red-icon.png" width="30" height="20"> High&emsp;</button>
                                <button type="submit" style="background: none;border: none;" name="btnmedium"><img
                                        src="img/orange-icon.png" width="17"
                                        height="18">&nbsp;&nbsp;Medium&emsp;</button>
                                <button type="submit" style="background: none;border: none;" name="btnlow"><img
                                        src="img/Yellow-icon.png" width="17" height="18">&nbsp;&nbsp;Low</button>
                            </form>
                        ...
                        <div class="col-8"><br>
                            <div class="categories-mytasks-1-active">
                                ...
                                <form method="post">
                                    <button type="submit" style="background: none;border: none;" name="btnall">
                                        <p class="category-mytasks1 active" id="b1">All</p>
                                    </button>
                                    <button type="submit" style="background: none;border: none;" name="btnactive">
                                        <p class="category-mytasks1" id="b2">Active</p>
                                    </button>
                                    <button type="submit" style="background: none;border: none;" name="btncompleted">
                                        <p class="category-mytasks1 " id="b3">Completed</p>
                                    </button>
                                </form>
          ...
          if($flag == 0)
          {
            ...
            if($res == TRUE)
            {
                ...
                ?>
                   ...
                   {
                ?>
                                <img src="img/orange-icon.png" class="orange1" width="20" height="20">
                                <?php
                    }
                    elseif($priority == '1')
                    {
                ?>
                                <img src="img/Yellow-icon.png" class="yellow" width="20" height="20">
                                <?php
                    }
                ?>
                                <span>
                                    <p class="light_spanItem_singleTask_myTasks add1">Added on</p>
                                ...
                                <span>
                                    <p class="type" style="color:#333333;line-height:1px "><?php echo $job_type; ?></p>
                                    <p class="opening" style="color:#979797; "><?php echo $openings; ?> openings</p>
                                </span>

                                <!-- <button class="x1" onclick="location.href='job_listings_individual.php?j_id=<?php echo $job_id; ?>'"><?php echo '<img src="data:image;base64,'.base64_encode($workspace_view).' " class="img1" style="width: 50px; height: 50px;" >' ;   ?></button> -->
                                <img src="img/profile1.png" alt="" class="img2">
                                <span class="company">
                                    <p style="color:#979797;line-height:1px ">Company contact</p>
                                    <p style="color:#3598DB;line-height:1px ">
                                        <b><?php echo $contact_client_company; ?></b>
                                    </p>
                                    <p style="color:#333333"><?php echo $client_company; ?></p>
                                </span>
                                <span class="eye">
                                    <img src="img/eye-icon.jpg" width="35" height="25"><br>
                                    <p style="color:#333333; "><b>&nbsp;<?php echo $job_views; ?></b></p>
                                </span>
                                <span class="task">
                                    <img src="img/task-icon.png" width="35" height="25"><br>
                                    <p style="color:#333333; "><b>&nbsp;6</b></p>
                                </span>
                                <span class="person">
                                    <img src="img/person-icon.png" width="35" height="25"><br>
                                    <p style="color:#333333; "><b>&nbsp;1/4</b></p>
                                </span>
                                <!-- <?php echo '<img src="data:image;base64,'.base64_encode($rec_img).' "  style="width: 55px; height: 55px;" >' ;   ?> -->
                                <img src="img/profile1.png" alt="" class="img_1">
                                <span class="mj1">
