                ...
                <div class="recent-activity">
                        ...
                        <div class="content">
                            ...
                            <div class="recent-content">
                                ...
                                <p class="recent-content-content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos t</p>
                            </div>
                    ...
                    <div class="mail-box">
                        <div class="box-content" id="list">
                            ...
                            <div class="box-content-rounded">
                                <p><a href="#" onclick="divVisibility('Div2');"><i class="fa fa-phone fa-lg" aria-hidden="true"></i></a></p>
                            </div>
                            <div class="box-content-rounded">
                                <p><a href="#" onclick="divVisibility('Div3');"><i class="fa fa-suitcase fa-lg" aria-hidden="true"></i></a></p>
                            </div>
                            <div class="box-content-rounded">
                                <p><a href="#" onclick="divVisibility('Div4');"><i class="fa fa-question fa-lg" aria-hidden="true"></i></a></p>
                            </div>
                            <div class="box-content-rounded">
                                <p><a href="#" onclick="divVisibility('Div5');"><i class="fa fa-comments fa-lg" aria-hidden="true"></i></a></p>
                            </div>
                            <div class="box-content-rounded">
                                <p><a href="#" onclick="divVisibility('Div6');"><i class="fa fa-pencil fa-lg" aria-hidden="true"></i></a></p>
                            </div>
                            <div class="box-content-rounded">
                                <p><a href="#" onclick="divVisibility('Div7');"><i class="fa fa-file fa-lg" aria-hidden="true"></i></a></p>
                            </div>
                        </div>
