            ...
            <div class="right-side-row-for-add-client-container-1" id="personal-information-addcontact-1">
                ...
                <div class="left-side-image-box-add-client-1">
                        <div class="sub-divs-image-box-right-side-add-client">
                            <input type="file" class="input-image-upload-ekam-1-add-client" id="input-image-upload-ekam-1-add-client" name="picture" required>
                    ...
                    <div class="right-side-image-box-right-add-client-1">
                        <div class="row-recruiter sub-divs-image-box-right-side-add-client">
                            ...
                            <p class="input-para-add-client-ekam-1 fx-city-name-1">
                                ...
                                <input type="text" name="fname" class="default-input-for-add-client-1" placeholder="First name" id="default-input-for-no.1" required>
                            </p>
                                                <!-- LASTNAME -->
                            <p class="input-para-add-client-ekam-1 fx-city-name-1">
                                <label for="default-input-for-no.1011">Last name *</label>
                                <input type="text" name="lname" class="default-input-for-add-client-1" placeholder="Last name" id="default-input-for-no.1011" required>
                            </p>
                                                        <!-- STATUS -->
                            ...
                            <div class="row-recruiter inputs-for-add-client-below-image-box">
                                <p class="input-para-add-client-ekam-1">
                                    ...
                                    <input type="text" name="mname" class="default-input-for-add-client-1" placeholder="Middle name" id="default-input-for-no.2" required>
                                </p>
                                                             <!-- TITLE -->
                                <p class="input-para-add-client-ekam-1">
                                    <label for="default-input-for-no.2">Title * </label>
                                    <input type="text" name="title" class="default-input-for-add-client-1" placeholder="Title" id="default-input-for-no.2" required>
                                </p>
                                                        <!-- EMAIL -->

                                <p class="input-para-add-client-ekam-1">
                                <label for="default-input-for-no.2">Main Email * </label>
                                    <input type="email" name="email" class="default-input-for-add-client-1" placeholder="Main email ID" id="default-input-for-no.2" required>
                                    <a href=""><i class="fa fa-plus" style="color:blue"></i></a> </input>
                                </p>
                                                        <!-- CONTACT NUMBER -->
                                <p class="input-para-add-client-ekam-1">
                                    <label for="default-input-for-no.2">Contact number * </label>
                                    <input type="tel" maxlength="10" name="phone" class="default-input-for-add-client-1" placeholder="Contact number" id="default-input-for-no.2" pattern="[789][0-9]{9}" required>
                                ...
                                <div class="row-recruiter inputs-for-add-client-below-image-box" style="width:100%">
                                    <p class="input-para-add-client-ekam-1">
                                            ...
                                            <input id="default-select-for-no.13" name="address" type="text" class="default-input-for-add-client-1" placeholder="Enter your address" required>
                                   </p>                           <!--   CITYNAME -->
                                    ...
                                    <p class="input-para-add-client-ekam-1 fx-zipcode">
                                            ...
                                            <input id="default-select-for-no.13" name="zip_code" type="number" class="default-input-for-add-client-1" placeholder="Enter zipcode of city" required>
                                    </p>
                                                            <!-- STATE -->
                                        ...
                                        <label for="default-select-for-no.6">Country</label>
                                            <select name="country" id="default-select-for-no.6" class="default-select-for-add-client-1"required>
                                                ...
                                                <option value="3">Working</option>
                                                    ...
                                                    <!-- SAVE BUTTON -->
                                <button type = "submit" name = "next" class="save_button_addClient default-button-for-recruiter-dashboard" value="Save" >&emsp;save &emsp;<i class="fa fa-save"></i>&emsp;</button>
                            </div>
                    </div>
                </div>
            </div>
