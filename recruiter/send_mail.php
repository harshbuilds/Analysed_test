                ...
                <div class="card-body">
                    ...
                    <form action="email-script.php" method="post" class="form-signin">
                        <div class="form-label-group">
                            ...
                            <input type="text" name="fromEmail" id="fromEmail" class="form-control" placeholder="Enter email" value= "<?php echo $_SESSION['gmail'] ?>" >
                        </div> <br/>
                        <div class="form-label-group">
                        ...
                        <!-- <label for="inputPassword">Attachment<span style="color: #FF0000">*</span></label>
                        <div class="form-label-group">
