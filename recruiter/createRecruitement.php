...
<div class="container">
    <div class="bread-crumbs_Mytools-recruiter">
        <a href="./dashboard.php">Dashboard</a> > <a href="">My Database</a> > <a href="">Job listings</a> ><a href="#">Create Recruitement</a>
    </div>
    <div class="small_container">
        ...
        <div class="header_img_cr">   <!--Extra part added, required for responsiveness -->
           <a href="./dashboard.php"> <img src="img/client_back.JPG" class="back_img_cr"></a> <!-- back to dashboard pg-->
                        ...
                        <div class="right-side-image-box-right-add-client-1 create-rec">
                            <div class="row-recruiter sub-divs-image-box-right-side-add-client">
                                <div class="row-recruiter inputs-for-add-client-below-image-box" id="block1">
                                    <p class="select-for-select-image-box-below-inputs_cr fx-city-name-1 create-rec-100-temp-p">
                                    ...
                                    <p class="select-for-select-image-box-below-inputs_cr fx-city-name-1 create-rec-100-temp-p">
                                        <label for="default-select-for-no.3" id="fields">Name of the client company *</label>
                                    ...
                                    <p class="select-for-select-image-box-below-inputs_cr fx-city-name-1 create-rec-100-temp-p">
                                        <label for="default-select-for-no.4" id="fields">Contact at client company *</label>
                                    ...
                                    <p class="select-for-select-image-box-below-inputs_cr fx-city-name-1 create-rec-100-temp-p">
                                        <label for="default-select-for-no.5" id="fields">Business Development Manager *</label>
                                ...
                                <input type="submit" name="next" class="save_button_addClient default-button-for-recruiter-dashboard" id="save_cr" value="save">
                            </div>
                        </form>
                    </div>
                </div>
