    ...
    <div class="container">
      ...
      <div class="small_container">
        <div class="bread-crumbs_Mytools-recruiter">
            <a href="dashboard.php" class="unactive-breadcrumb-link">Dashboard</a> > <a href="" class="active-breadcrumb-link">Applied Candidates</a>
        </div>
        ...
        <div class="row-flex-jobs-j alignitemsstart-shortlisted Dashboard-main-container-jobs">
            ...
            <div class="right-side-container-DashboardJ">
                ...
                <div class="category-main-first">
                        ...
                        <label for="Location" class="label-applied-candidates"><b>Location</b></label>
                ...
                <div class="category-main-first">
                    <p class="row-flex-jobs-j">
                        <span class="heading-filter-dj" id="filterHeading3"><b>Qualification</b></span>
