...
<body>
    ...
    <div id="upload-modal">
        <div id="upload-container">
            <p class="l1" style="margin-left:50px;margin-top:50px">Select the type of user
                <span id="closeit" class="l2" style="margin-left:700px">Close</span><br>
                <span class="l2" style="line-height:1.2">Select a pre-defined user template or create a new one.</span>
            </p><br><br>
            <div class="row" id="def1">
                <div class="col-4">
                    <p id="ex1">&emsp;Lorem Ipsum&emsp;&emsp;&emsp;<i class="fa fa-cogs"></i></p><br>
                    <p id="ex2">&emsp;Lorem Ipsum&emsp;&nbsp;<i class="fa fa-shield"></i></p>
                </div>
                <div class="col-4">
                    <p id="ex3">&emsp;Lorem Ipsum&emsp;&nbsp;<i class="fas fa-money-bill-wave"></i></p><br>
                    <p id="ex4">&emsp;Lorem Ipsum&emsp;&nbsp;<i class="far fa-heart"></i></p>
                </div>
                <div class="col-4">
                    <p id="ex5">&emsp;Lorem Ipsum&emsp;&emsp;&nbsp;<i class="far fa-building"></i></p><br>
                    <a href="create_new_user.php">
                        <p id="ex6">&emsp;Recruiter&emsp;<i class="fab fa-black-tie"></i></p>
                    </a>
                </div>
            </div>
            <br><br>
            <a href="create_customer_user1.php"><span class="l1" id="ex_9">Create custom user <i
                        class="fas fa-user-edit"></i></span></a>
            <span class="g1"><a href="#">Proceed</a></span>
            </p>
        </div>
    </div>
    ...
    <div class="main_body">
        <div class="container">
            ...
            <div class="task_1">
                <div class="card" id="c1">
                    <div class="int_1">
                        ...
                        <p class="t4"><i class="fa fa-check-circle" aria-hidden="true"></i> Lorem ipsum dolor sit amet,
                            capetr adipisci elit.</p>
                        <p class="t4"><i class="fa fa-check-circle" aria-hidden="true"></i> Lorem ipsum dolor sit amet,
                            capetr.</p>

                        <p class="t5">Sign Up</p>
                    </div>
                </div>
                <div class="card" id="c1">
                    <div class="int_1">
                ...
                <div class="card" id="c2">
                    <div class="int_2">
                        ...
                        <p class="p4"><i class="fa fa-check-circle" aria-hidden="true"></i> Lorem ipsum dolor sit amet,
                            capetr adipisci elit.</p>
                        <p class="p4"><i class="fa fa-check-circle" aria-hidden="true"></i> Lorem ipsum dolor sit amet,
                            capetr.</p>

                        <p class="t5" style="color:#297FB8">Sign Up</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-9">
                    <p class="input-field1">
                        <a href="" class="active-breadcrumb-link dropdown input_filter">&emsp;<i class="fa fa-filter"
                                aria-hidden="true"></i>&emsp;All types</a>
                        <input type="text" name="searchForJobs" id="inputSearch" class="search-form-input filter_input"
                            placeholder="Search for users" />&emsp;&emsp;&emsp;&emsp;
                        <button class="searchButton">
                            <img src="img/search-icon-blue.png" width="15" height="15" style="font:right" />
                        </button>
                    </p>
                </div>
                <div class="col-3" id="cl3">
            ...
            <p class="t1" id="tt"><br><br>Existing user<br><br></p>
            <div class="task_5">
                <div class="card" id="c5">
                    <div class="int_5">
                        <p style="color:#EC4551"><i class="fa fa-trash" aria-hidden="true"></i>
                            <span id="mp1">profile <i class="fas fa-external-link-alt" aria-hidden="true"></i></span>
                        </p>
