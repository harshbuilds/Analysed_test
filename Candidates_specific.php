...
<div class="small_container1">
  ...
  <h1>John Smith<p1 style="font-family:verdana">#JB13069</p1></h1><br>
  <h2><span style="color:#3598DB">Web Developer-</span>Fox-Hunt</h2><br>
...
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#3598DB" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
     ...
     <p style="color:black">Contract Job</p>
     </div>
     <div class="source2">
     ...
     <span>Node.js&emsp;&emsp;
     <br><br></span>

     <span>MYSQL&emsp;&emsp;
     </span>
     </div>
     <div class="status">
     </div>
     ...
     <p style="color:#3598DB">Web-Developer
     <span style="color:black; font-size:15px">|B.Tech</span></p>
    ...
    <br><br>
     Address<br><br>
    <span style="color:black">Address line 1<br>
    City-12345<br>
    State,Country.</span><br>
    <br><br>
    Owner<br><br>
...
<span style="color:#3598DB; font-size:15px; font-family:Metro">abc@gmail.com</span><br><br>
<span style="color:black; font-size:15px; font-family:Metro">+91 98765654321<br><br>
+91 98765654321<br><br><br>
