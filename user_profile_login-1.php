...
<body>
    ...
    <div class="row" style="margin-left:20px">
        ...
        <div class="col-10" >
            ...
            <div class="back-btn">
               <p><a href="user_profile_login.php">Back to calendar <i class="fas fa-angle-left"></i> </a></p>
               <p class="session-right-class-1">session X Hours Y minutes on <br><span> 08-05-2020</span></p>
           </div>
           <div class="row">
                <div class="col-3" >
                    <p class="s1" style="background-color: #EC45512E ;"><i class="fas fa-sign-out-alt"></i></p>
                </div>
                <div class="col-9">
                    <p class="t1">
                        <p class="s2">Logged out &emsp; <img src="img/grey-clock-icon.png" height="15px" width="15px">
                        <span class="v3"> X minutes ago</span><br>
                        <span class="v3">Session details Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna</span><br>
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-3" >
                    <p class="s1"><i class="fas fa-sign-in-alt"></i></p>
                </div>
                <div class="col-9">
                    <p class="t1">
                        <p class="s2">Logged in &emsp; <img src="img/grey-clock-icon.png" height="15px" width="15px">
                        <span class="v3"> X minutes ago</span><br>
                        <span class="v3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna</span><br>
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <p class="t1">
                        <p class="s2">Logged in from unknown device &emsp; <img src="img/grey-clock-icon.png" height="15px" width="15px">
                        <span class="v3"> X minutes ago</span><br>
                        <span class="v3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna</span><br>
                    </p>
                </div>
